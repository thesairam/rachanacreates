...
export default function Footer() {
  ...
  return (
    <>
      ...
      <footer className="fixed bottom-0 inset-x-0 z-40 border-t border-border bg-bg2/95 backdrop-blur" role="contentinfo">
        <div className="container-x py-3 flex flex-wrap items-center justify-between gap-3 text-muted text-sm">
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
            ...
            <button
              ...
              className="underline hover:text-text transition-colors bg-transparent border-0 cursor-pointer text-sm text-muted p-0"
            >
              {t.footer.legal}
            </button>
            <span className="opacity-60">·</span>
            <a
              href="https://share.google/pdaUgJDwVit7e9XxN"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-text transition-colors text-sm"
              title="Leave us a Google review"
            >
              ⭐ {t.footer.review}
            </a>
            <span className="opacity-60">·</span>
            <a href="https://www.linkedin.com/in/sairam25/" target="_blank" rel="noopener noreferrer" className="hover:text-text transition-colors text-sm">
              {t.footer.credit}
            </a>
          </div>
